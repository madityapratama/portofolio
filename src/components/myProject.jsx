...
function myProject() {
  ...
  const projects = [
    {
      id: 1,
      title:
        "Designing a Midmanners System for Joint Account Administration Services in Game Trading",
    ...
    },
    {
      id: 2,
      title:
        "Web-based Archive Management Information System (SIM-A) at BPKPAD Banjarmasin City",
    ...
    },
    {
      id: 4,
      title:
        "Midmanners System Database Design for Joint Account Administration Services in Game Trading",
  ...
  return (
    <section className="flex-1 bg-gradient-to-r from-[#0d1117] via-gray-800 to-blue-900 min-h-screen">
      <h2 className="font-poppins text-3xl md:text-4xl font-bold mb-10 text-white pt-40 px-6 md:px-20">
        My Projects
      </h2>

      {/* Grid layout */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-6 md:px-20 pb-20">
        {projects.map((p) => (
          <div
            key={p.id}
            onClick={() => {
            ...
            className="rounded-xl border border-gray-600 bg-gray-900/60 hover:scale-105 transition-transform duration-300 overflow-hidden cursor-pointer shadow-md"
          >
            <Image
              src={p.img}
              alt={p.title}
            ...
            <div className="p-4">
              ...
              <p className="text-gray-300 text-sm mt-2 line-clamp-3">{p.desc}</p>
      ...
      {isOpen && activeProject !== null && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 px-4">
          <div className="bg-gray-900 p-6 rounded-xl relative max-w-5xl w-full max-h-[90vh] overflow-y-auto">
            <button
